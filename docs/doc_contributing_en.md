...
| Build & Dependencies | Build scripts, CMake entry, third-party dependency descriptions | `docs/build_and_test_en.md`, `docs/dependencies_en.md` |
| API References(Chinese) | API functionality, prototypes, parameters, return values and constraints | `docs/zh/api/` |
| Usage Guides | API invocation workflow, protocol capabilities and notes | `docs/` |
...
```text
README_en.md ──Quick Start──→ docs/quick_start_en.md
             ──Build & Test──→ docs/build_and_test_en.md
             ──Dependencies──→ docs/dependencies_en.md
             ──API Reference(Chinese)──→ docs/zh/api/README.md
             ──Samples──→ examples/README_en.md

docs/quick_start_en.md ──Sample doc──→ examples/hcomm_write_read_nbi/README_en.md
docs/build_and_test_en.md ──Dependencies──→ docs/dependencies_en.md

docs/zh/api/ ──Invocation sample──→ examples/ain/basic_ring/README.md
```
