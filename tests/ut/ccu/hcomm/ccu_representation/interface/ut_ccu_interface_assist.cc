...
{
    ccu_rep::ccu_ins_generater_v1 insGen;
    std::shared_ptr<ccu_rep::ccu_rep_base> rep = std::make_shared<ccu_rep::ccu_rep_block>(&insGen, "test_rep");

    EXPECT_THROW(append_to_context(nullptr, rep), CcuUtException);
}
