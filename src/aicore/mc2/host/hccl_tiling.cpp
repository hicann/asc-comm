...
#include "mc2/hccl_tiling.h"
#include "mc2/hccl_common.h"
#include "securec.h"
#include "../../detail/host_log.h"
#include "mc2/internal/hccl_msg.h"
#include "mc2/internal/hccl_tiling_msg.h"
#include "tiling/platform/platform_ascendc.h"
...
uint32_t SetDevType(Mc2InitTilingInner* tilingInner)
{
    ...
    ASCENDC_HOST_ASSERT((homePath != nullptr && homePath[0] != '\0'), return EXIT_FAILURE,
        "ASCEND_HOME_PATH is not set or empty.");
