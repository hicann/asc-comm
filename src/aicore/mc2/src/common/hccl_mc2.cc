...
{
    HCCL_RUN_INFO("[MC2_CLIENT_A5_AICPU] enter asc-comm common HcclAllocComResourceByTiling, "
...
{
    HCCL_RUN_INFO("[MC2_CLIENT_A5_AICPU] enter asc-comm explicit A5 MC2 resource allocator, "
        "comm[%p], stream[%p], tiling[%p].", comm, stream, mc2Tiling);
