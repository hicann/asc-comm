...
repeat::repeat(ccu_rep_context* context, ccu_relational_operator<variable, uint64_t> rel) : context_(context)
{
...
bool repeat::check() const { return !is_executed_; }

void repeat::run() { is_executed_ = true; }
