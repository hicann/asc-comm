...
#ifndef ASCCOMM_CCU_REPRESENTATION_READ_H
#define ASCCOMM_CCU_REPRESENTATION_READ_H
...
class ccu_rep_read : public ccu_rep_base {
public:
    ccu_rep_read(
...
#endif // ASCCOMM_CCU_REPRESENTATION_READ_H
