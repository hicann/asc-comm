...
#ifndef HCCL_CCU_REPRESENTATION_XOR_H
#define HCCL_CCU_REPRESENTATION_XOR_H
...
class ccu_rep_xor : public ccu_rep_base {
public:
    ccu_rep_xor(
        ccu_ins_generater_base* ins_gen_ptr, const variable& var_c, const variable& var_a, const variable& var_b);
    ccu_rep_xor(ccu_ins_generater_base* ins_gen_ptr, const variable& var_c, const variable& var_b);
    ...
    xor_sub_type get_sub_type() const { return sub_type_; }

    std::string describe() override;

private:
    xor_sub_type sub_type_{xor_sub_type::invalid};
...
#endif // HCCL_CCU_REPRESENTATION_XOR_H
