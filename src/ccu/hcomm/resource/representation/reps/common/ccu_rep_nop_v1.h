...
#ifndef ASCCOMM_CCU_REPRESENTATION_NOP_H
#define ASCCOMM_CCU_REPRESENTATION_NOP_H
...
class ccu_rep_nop : public ccu_rep_base {
public:
    explicit ccu_rep_nop(ccu_ins_generater_base* ins_generator_ptr);
