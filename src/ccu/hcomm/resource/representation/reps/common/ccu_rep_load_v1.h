...
#ifndef ASCCOMM_CCU_REPRESENTATION_LOAD_H
#define ASCCOMM_CCU_REPRESENTATION_LOAD_H
...
class ccu_rep_load : public ccu_rep_base {
public:
    explicit ccu_rep_load(ccu_ins_generater_base* ins_gen_ptr, uint64_t addr, const variable& var, uint32_t num = 1);
