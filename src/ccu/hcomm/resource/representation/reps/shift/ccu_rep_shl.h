...
class ccu_rep_sh_l : public ccu_rep_base {
public:
    ccu_rep_sh_l(
        ccu_ins_generater_base* ins_gen_ptr, const variable& var_d, const variable& var_n, const variable& var_m);
    ccu_rep_sh_l(ccu_ins_generater_base* ins_gen_ptr, const variable& var_d, const variable& var_m);
    ccu_rep_sh_l(
        ccu_ins_generater_base* ins_gen_ptr, const address& addr_d, const variable& var_n, const variable& var_m);
    ccu_rep_sh_l(ccu_ins_generater_base* ins_gen_ptr, const address& addr_d, const variable& var_m);
