...
#ifndef ASCCOMM_CCU_REPRESENTATION_SUB_H
#define ASCCOMM_CCU_REPRESENTATION_SUB_H
...
class ccu_rep_sub : public ccu_rep_base {
public:
    explicit ccu_rep_sub(
    ...
    explicit ccu_rep_sub(ccu_ins_generater_base* ins_gen_ptr, const variable& var_a, const variable& var_b);
    explicit ccu_rep_sub(ccu_ins_generater_base* ins_gen_ptr, const variable& var_a, uint16_t immed_b);
    ...
    explicit ccu_rep_sub(ccu_ins_generater_base* ins_gen_ptr, const address& addr_a, const variable& var_b);
    explicit ccu_rep_sub(ccu_ins_generater_base* ins_gen_ptr, const address& addr_a, const uint16_t immed_b);
    ...
    minus_sub_type get_sub_type() const;

private:
    ccu_ins_generater_base* ins_gen_ptr_{nullptr};
    minus_sub_type sub_type_{minus_sub_type::invalid};
    ...
    void validate_ins_gen_ptr_for_sub() const;
    bool support_ccu_v1_{false};
};

}; // namespace ccu_rep
}; // namespace asc
#endif // ASCCOMM_CCU_REPRESENTATION_SUB_H
